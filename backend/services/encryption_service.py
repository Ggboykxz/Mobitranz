...
class EncryptionService:
    ...
    def encrypt_aesgcm(self, data: bytes, key: bytes) -> Tuple[bytes, bytes]:
    ...
    def decrypt_aesgcm(self, ciphertext: bytes, key: bytes, nonce: bytes) -> bytes:
    ...
    def compute_audit_hash(self, previous_hash: str, data: str, timestamp: str) -> str:
    ...
    def encrypt_video_chunk(self, chunk: bytes, trip_key: bytes) -> Tuple[bytes, bytes]:
    ...
    def decrypt_video_chunk(
        self, encrypted_chunk: bytes, trip_key: bytes, nonce: bytes
    ) -> bytes:
