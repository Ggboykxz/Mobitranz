...
class MatchingService:
            ...
            if driver.current_lat and driver.current_lon:
                ...
                if distance <= radius_km:
                    ...
                    available_taxis.append({
                        "driver_id": driver.id,
                        "driver_name": f"{driver.user.first_name} {driver.user.last_name}" if driver.user else "Inconnu",
                        ...
                        "available_seats": vehicle.available_seats if vehicle else 4,
    ...
    async def calculate_estimated_fare(
        ...
        fare_info = await geo_service.calculate_trip_fare(
            db=db,
    ...
    async def get_matching_score(
        ...
        total_score = (distance_score * 0.4) + (rating_score * 0.3) + (trips_score * 0.2) + (seats_score * 0.1)
