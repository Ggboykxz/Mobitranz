...
class UserRegister(BaseModel):
    ...
    password: str = Field(..., description="Mot de passe", min_length=8)
    first_name: Optional[str] = Field(None, description="Prénom", max_length=100)
    last_name: Optional[str] = Field(None, description="Nom", max_length=100)
...
class BiometricLogin(BaseModel):
    ...
    biometric_hash: str = Field(..., description="Hash des données biométriques")
