...
class RedisClient:
    ...
    async def set_proposal_active(
        self, trip_id: str, driver_id: str, data: dict, window_seconds: int = 30
    ):
        ...
        await client.setex(key, window_seconds, json.dumps(data, ensure_ascii=False))

    async def is_proposal_active(self, trip_id: str, driver_id: str) -> bool:
