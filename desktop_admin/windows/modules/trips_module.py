...
class TripsModule(ctk.CTkFrame):
    ...
    def __init__(self, master, user_data=None, dashboard=None, **kwargs):
        ...
        kpis = [("🗺️", "Total", "12,847"), ("🚗", "Actifs", "127"), ("✅", "Terminés", "12,520"), ("⏳", "En attente", "24")]
        ...
        card = FluentCard(self, title="Historique des trajets")
        card.pack(fill="both", expand=True)
        content = ctk.CTkFrame(card, fg_color="transparent")
        content.pack(fill="both", expand=True, padx=20, pady=(0, 20))
        
        headers = ["ID", "Client", "Conducteur", "Département", "Arrivée", "Statut"]
        ...
        trips = [
            ("trip_9835", "Client #4825", "Jean O.", "Libreville", "PK-50", "TERMINÉ"),
            ("trip_9834", "Client #4824", "Marie K.", "Libreville", "PK-12", "TERMINÉ"),
            ("trip_9833", "Client #4823", "Paul M.", "Port-Gentil", "PK-8", "EN COURS"),
        ]
        for t in trips:
